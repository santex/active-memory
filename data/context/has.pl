...
print Dumper ( $g->has_doc( 'doc-1'), "Found doc 1" );
print Dumper ( $g->has_doc( 'doc-9'), "Found doc 9" );
print Dumper ( !defined( $g->has_doc( 'doc-11' )), "Nonexistent document is undefined" );
print Dumper ( !defined( $g->has_doc( 'doc-101' )), "Nonexistent document is undefined" );

print Dumper ( $g->has_term( 'months-old black truffle'), "Found 'months-old black truffle'" );
print Dumper ( $g->has_term( 'ravioli'), "Found 'ravioli'" );
print Dumper ($g->has_term( 'moustache' ), undef , "Nonexistent term is undefined" );
print Dumper ( !defined( $g->has_term( 'snake eyes' )), "Nonexistent term is undefined" );
